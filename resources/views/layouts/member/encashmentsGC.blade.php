...
<div class="row m-t-25" >
	...
	<div class="col-md-4">
	<h2>GC Withdrawal</h2>
	<form  class="form-header" role="form" method="POST" action="{{ route('encashmentsGC.submit') }}" onsubmit="submit_btn3.disabled = true; return true;" >
		...
		<div class="form-group col-md-12" style="padding:0px;">
			...
			<div class="form-group ">
				@if(count($accounts) > 0)
				<select class="form-control col-md-6 input-lg"  name="account_name" id="account_name" onchange="selectGC(this.value)">
			...
			<div class="form-group ">
				<select class="form-control col-md-6  input-lg" name="product" id="product">
					<option value="3IN1SOAP">3in1 Soap - 250</option>
					<option value="LOTION">Lotion - 350</option>
					<option value="AROMAOIL">Aroma oil - 300</option>
					<option value="VITAMINC">Vitamin C - 375</option>
					<option value="SERPENTINA">Serpentina - 485</option>
					<option value="GLUTACAPSUL">Glutathione Capsul - 1500</option>
					<option value="OATMEALSOAP">Oatmeal Soap - 250</option>
					<option value="SPIRULINA">Spirulina - 750</option>
				</select> 
			</div>
			<div class="form-group ">
				<select class="form-control col-md-6  input-lg" name="qty" id="qty">
					@for($x=1;$x<101;$x++)
	...
	<div class="col-md-4">
		...
		<div class="panel panel-default card" style="padding:20px">
			<center>
		  <div class="panel-heading"><h5>GC</h5></div>
		  <div class="panel-body">
		  	<h2><strong>&#8369; {{number_format(getTotalAvailableGC(Auth::user()->username,$selectedAccount),2)}}</strong></h2>
		  </div>
		</center>
		</div>
												...
												<table class="table table-bordered table-striped mb-0">
													<thead>
														<tr>
															...
															<th style="width:10%; font-size: 14px;">Status</th>
													...
													<tbody>
														...
														<tr>
															...
															<td style="font-size: 14px;">{{$encash->product}}</td>
															<td style="font-size: 14px;">{{$encash->qty}}</td>
															<td style="font-size: 14px;">{{$encash->amount}}</strong></td>
...
function selectGC(account_name){
