	...
	<div class="col-lg-12" >
		<div class="row" >
						...
						<div class="card-body ">
									...
									<form  class="form-header" role="form" method="POST" action="{{ route('add-accounts.submit') }}" onsubmit="submit_btn.disabled = true; return true;" >
										...
										<div class="form-group col-md-12" style="padding:0px;">
											...
											<div class="form-group col-md-12" style="padding:0px;">
												<input class="form-control input-md border-gold" name="sponsor" id="sponsor" type="text" placeholder="" value="{{Request::old('sponsor')}}" required>
											</div>
											<label for="upline" class="control-label mb-1">Upline</label>
											<div class="form-group col-md-12" style="padding:0px;">
												<input class="form-control input-md border-gold" name="upline" id="upline" type="text" placeholder="" value="{{Request::old('upline')}}" required>
											</div>
											<label for="upline" class="control-label mb-1">Position</label>
											<div class="form-group col-md-12" style="padding:0px;">
								...
								<table class="table table-bordered table-striped mb-0">
									<thead >
										<tr>
											...
											<th style="width:20%; font-size: 14px;">Sponsor</th>
											<th style="width:20%; font-size: 14px;">Placement</th>
											<th style="width:40%; font-size: 14px;" class="text-right">Date</th>
										</tr>
									</thead>
									<tbody>
										<?php $x=1; ?>
										...
										<tr>
											...
											<td style="font-size: 14px;">{{$acc->placement}}</td>
											<td class="text-right" style="font-size: 14px;">{{$acc->created_at}}</td>
										</tr>
										@endforeach
